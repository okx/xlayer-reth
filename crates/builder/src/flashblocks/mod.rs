...
pub struct FlashblocksConfig {
    ...
    /// Maximum number of concurrent WebSocket connections per IP address (0 = disabled)
    pub ws_per_ip_limit: Option<u16>,

    /// Idle timeout in seconds for WebSocket connections (0 = disabled)
...
impl Default for FlashblocksConfig {
    fn default() -> Self {
        Self {
            ...
            ws_per_ip_limit: None,
            ws_idle_timeout_secs: None,
