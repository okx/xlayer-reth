...
pub struct InternalTransaction {
    pub(crate) dept: u64,
    pub(crate) internal_index: u64,
    pub(crate) call_type: String,
    pub(crate) name: String,
    pub(crate) trace_address: String,
    pub(crate) code_address: String,
    ...
    pub(crate) call_value_wei: String,
...
pub struct TraceCollector {
    pub(crate) all_traces: Vec<Vec<InternalTransaction>>,
    pub(crate) traces: Vec<InternalTransaction>,
    // depth
    pub(crate) current_path: Vec<usize>,
    // internal_index
    pub(crate) last_depth: usize,
    pub(crate) sibling_count: Vec<usize>,
...
impl TraceCollector {
    pub(crate) fn format_error(result: &InstructionResult) -> String {
        match result {
    ...
    pub(crate) fn before_op(&mut self) {
    ...
    pub(crate) fn after_op(&mut self) {
