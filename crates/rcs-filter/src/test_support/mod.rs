//! Test support: golden fixtures (contract §4, verbatim constants), a deterministic clock,
//! a log builder, and a hand-written [`RcsClient`] double (FR-10, spec Dependency Contract).
//!
