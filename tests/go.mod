...
// The XLayer Go E2E harness consumes the in-repo Optimism devstack and its
// op-geth fork through path/version replacements, mirroring the replace set the
// optimism module itself declares (Go does not inherit replaces transitively).
